...
\tikzset{
	...
	circle/.style      = {treenode, font=\ttfamily\normalsize},
	dummy/.style    = {circle,draw},
	level 1/.style={sibling distance=3.5cm, level distance = 2.2em},
...
\node (l4) [circle,draw,below=7mm of l3] {person};
...
\draw[->] (r1) -- node[above, sloped ] {\tiny{trait\_of}} (l3);
